...
std::string get_account(const std::string& filename) { return filename.substr(8, 8); }

std::string get_date(const std::string& filename) { return filename.substr(17, 8); }
